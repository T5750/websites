...
public class ImageServerIoHandler extends IoHandlerAdapter {
	...
	/**
	 * Creates a new instance of ImageServerIoHandler. For this step, we pass in
	 * a reference to the MBeanServer. This instance will be used to register
	 * new IoSession objects so that the JMX subsystem can report statistics on
	 * the sessions.
	 *
	 * @param mBeanServer
	 ...
	 * In here we will set up the JMX session MBean.
	 * 
	...
	public void sessionCreated(IoSession session) throws Exception {
		...
		ObjectName sessionName = new ObjectName(session.getClass().getPackage()
				.getName()
				+ ":type=session,name="
