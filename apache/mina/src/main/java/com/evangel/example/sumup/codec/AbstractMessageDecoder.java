 ...
 *
 */
package com.evangel.example.sumup.codec;
...
import com.evangel.example.sumup.message.AbstractMessage;

/**
 * A {@link MessageDecoder} that decodes message header and forwards the
 * decoding of body to a subclass.
 *
