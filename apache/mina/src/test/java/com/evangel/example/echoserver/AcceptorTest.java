 ...
 *
 */
package com.evangel.example.echoserver;
...
import com.evangel.example.echoserver.ssl.SslServerSocketFactory;
import com.evangel.example.echoserver.ssl.SslSocketFactory;
...
public class AcceptorTest extends AbstractTest {
	...
	public void testTCPWithSSL() throws Exception {
		...
		testTCP0(SslSocketFactory.getSocketFactory().createSocket("localhost",
				port));
	}
