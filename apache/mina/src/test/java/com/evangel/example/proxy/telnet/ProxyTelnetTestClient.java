 ...
 *
 */
package com.evangel.example.proxy.telnet;
...
/**
 * ProxyTelnetTestClient.java - Tests a classical text communication through a
 * proxy. Changing the params and request type will allow to test the multiple
 * options (http or socks proxying, various authentications methods, ...).
 * 
...
public class ProxyTelnetTestClient {
	...
	public ProxyTelnetTestClient() throws Exception {
		...
		/*
		 * // Example of socks v5 proxy use SocksProxyRequest req = new
		 * SocksProxyRequest( SocksProxyConstants.SOCKS_VERSION_5,
