 ...
 * 订单消息模型，只要模型中各个字段的类型和顺序和OrderMessage一样，即可用Kryo 反序列出消息
 */
public class OrderMessage implements Serializable {
	...
	public String toString() {
		return "OrderMessage{" + "orderId=" + orderId + ", buyerId='" + buyerId
				+ '\'' + ", productId='" + productId + '\'' + ", salerId='"
				+ salerId + '\'' + ", createTime=" + createTime
