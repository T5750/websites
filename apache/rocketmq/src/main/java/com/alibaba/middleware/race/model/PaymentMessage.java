 ...
 * 订单消息模型，只要模型中各个字段的类型和顺序和PaymentMessage一样，即可用Kryo 反序列出消息
 */
public class PaymentMessage implements Serializable {
	...
	public static PaymentMessage[] createPayMentMsg(OrderMessage orderMessage) {
		...
		list[0].payAmount = rand
				.nextInt((int) (orderMessage.getTotalPrice() / 2));
	...
	public String toString() {
		return "PaymentMessage{" + "orderId=" + orderId + ", payAmount="
				+ payAmount + ", paySource=" + paySource + ", payPlatform="
				+ payPlatform + ", createTime=" + createTime + '}';
	}
